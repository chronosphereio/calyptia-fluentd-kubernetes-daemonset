...
##### Multi-Arch images
- `Elasticsearch7`
  - `docker pull ghcr.io/calyptia/calyptia-fluentd-kubernetes-daemonset:v1.14.4-debian-elasticsearch7-1.0`
...
- `Opensearch`
  - `docker pull ghcr.io/calyptia/calyptia-fluentd-kubernetes-daemonset:v1.14.4-debian-opensearch-1.3`
...
- `Forward`
  - `docker pull ghcr.io/calyptia/calyptia-fluentd-kubernetes-daemonset:v1.14.4-debian-forward-1.0`
...
- `Kafka2`
  - `docker pull ghcr.io/calyptia/calyptia-fluentd-kubernetes-daemonset:v1.14.4-debian-kafka2-1.0`
