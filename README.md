...
- `Opensearch`
  - `docker pull ghcr.io/fluent/fluentd-kubernetes-daemonset:v1.14.4-debian-opensearch-1.2`
...
- `Kafka2`
  - `docker pull ghcr.io/fluent/fluentd-kubernetes-daemonset:v1.14.4-debian-kafka2-1.0`
